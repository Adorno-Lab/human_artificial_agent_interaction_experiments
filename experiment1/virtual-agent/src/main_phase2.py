...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        if p == 1:
            ...
            p = -1
        if p == 2 and sc == -1:
            va = VirtualAgent(topic, x_marker_tl, 1, screen_m, w_dim, w_pos)
            phase[0] = 0
