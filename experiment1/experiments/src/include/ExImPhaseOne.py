...
class ExImPhaseOne(PetriNet):
    ...
    def _create(self):
        ...
        # 7) Information area:
        # Human is in the information area, looking for help.
        in_places = []
        out_places = []
        bi_places = []
        self._add_transition(in_places, out_places, bi_places,
        ...
        # 8) Finish help:
        # Finish giving information to help the human.
        in_places = []
        out_places = []
        bi_places = []
        self._add_transition(in_places, out_places, bi_places,
        ...
        # 6) Give help:
        # Give instructions to help the human.
        in_transitions = [t_ext_index + 7]
        out_transitions = [t_ext_index + 8]
        bi_transitions = []
        self._add_place(in_transitions, out_transitions, bi_transitions,
                        'give_help')
